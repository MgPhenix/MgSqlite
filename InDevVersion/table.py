...
class Table(SQL_Execution):
    ...
    def updateValue(self,columnEqualityList : list, *args ) -> None:
        columnText = ""
        value = []
        for column in range(columnEqualityList):
        ...
        self.simpleExecute(self.database,"UPDATE "+self.name+"SET "+columnText+"WHERE "+condition)
